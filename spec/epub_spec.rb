...
Rspec.describe Epub do
  ...
  describe ".correct_html_to_xhtml" do
    it "should close all <p> tags" do
      expect(Epub.correct_html_to_xhtml(chapter_1_html)).to not_include "<p>"
    end

    it "should close all <br> tags" do
      expect(Epub.correct_html_to_xhtml(chapter_1_html)).to not_include "<br>"
    end
  end
end
